...
export default function SignUpGoogle() {
  ...
  const { googleEmail, googleName, googleSub, googleProfileImg } =
  ...
  const onSubForm = (_bodyData) => {
    if (date != null) {
      _bodyData.name = googleName;
      _bodyData.email = googleEmail;
      _bodyData.googleSub = googleSub;
      _bodyData.profile_img = googleProfileImg;
      _bodyData.dob = date;
  ...
  return (
    <div
      className={`light_box align-items-center `}
      style={{ color: "white", minHeight: "100vh" }}
    >
      <div
        style={{ border: "3px solid #fff", maxWidth: "400px" }}
        className="inside_box rounded-3 container mt-5 mb-5 "
      >
        ...
        >
            ...
            <div className="divs">
              ...
              {errors.username && (
                <div className="text-danger">
                  * הכנס שם משתמש תקין מעל 2 תווים
                </div>
              )}
              <label>טלפון</label>
              <input
              ...
              />
              {errors.phone && (
                <div className="text-danger">* הכנס טלפון תקין</div>
              )}
              <label>עיר</label>
              <input
              ...
              />
              {errors.city && (
                <div className="text-danger">* הכנס עיר תקינה</div>
              )}
              <label>מיקוד</label>
              <input
          ...
          <Link
            className="text-decoration-none mt-4 text-end"
